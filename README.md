...
This independent Liberu module owns the provider-neutral **Genealogy Research** capability.
...
- Composer package: `liberusoftware/module-genealogy-research`
- Module installer name: `genealogy-research`
- Category: capability
